...
<div class="summary-grid">
  <article class="summary stack">
    <h3><a href="/hire/access-and-arrival/">Access and arrival</a></h3>
    <p>Key boxes, alarm, heating, advance access requests and what to do before you leave.</p>
  </article>
  <article class="summary stack">
    <h3><a href="/hire/facilities-and-equipment/">Hall facilities and equipment</a></h3>
    <p>Kitchen stock, tables, chairs, stage setup and the practical limits that matter most.</p>
  </article>
  <article class="summary stack">
    <h3><a href="/hire/layout-and-outdoor-spaces/">Layout and outdoor spaces</a></h3>
    <p>A simpler building overview plus the updated policy on outdoor areas and the football pitch.</p>
  </article>
  <article class="summary stack">
    <h3><a href="/hire/terms-and-conditions/">Terms and conditions of hire</a></h3>
    <p>A web summary of the core responsibilities, with the full agreement still available to download.</p>
  </article>
  <article class="summary stack">
    <h3><a href="/hire/gallery/">Hall gallery</a></h3>
    <p>Browse the main hall, meeting room, kitchen and surrounding setting in a more visual guide.</p>
  </article>
  <article class="summary stack">
    <h3><a href="/hire/availability/">Availability calendar</a></h3>
    <p>See the officially supported embedded calendar on the Hub site before you move into the live booking system.</p>
  </article>
</div>
